  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'custom-primary': 'rgba(255, 255, 255, 0.28) 4px 4px 18px 0px inset, rgba(196, 69, 14, 0.5) 0px 0.48175px 2.40875px -0.833333px, rgba(196, 69, 14, 0.5) 0px 1.83083px 9.15413px -1.66667px, rgba(196, 69, 14, 0.5) 0px 8px 40px -2.5px, rgba(196, 69, 14, 0.5) 0px -0.48175px 2.40875px -0.833333px, rgba(196, 69, 14, 0.5) 0px -1.83083px 9.15413px -1.66667px, rgba(196, 69, 14, 0.5) 0px -8px 40px -2.5px',
        'custom-secondary': 'rgba(255, 255, 255, 0.28) 4px 4px 18px 0px inset, rgba(246, 116, 20, 0.5) 0px 0.48175px 2.40875px -0.833333px, rgba(246, 116, 20, 0.5) 0px 1.83083px 9.15413px -1.66667px, rgba(246, 116, 20, 0.5) 0px 8px 40px -2.5px, rgba(246, 116, 20, 0.5) 0px -0.48175px 2.40875px -0.833333px, rgba(246, 116, 20, 0.5) 0px -1.83083px 9.15413px -1.66667px, rgba(246, 116, 20, 0.5) 0px -8px 40px -2.5px',
